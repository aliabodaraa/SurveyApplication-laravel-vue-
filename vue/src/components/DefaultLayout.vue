...
<div>
    ...
    <div class="min-h-full">
      DefaultLayout
          <nav class="bg-gray-800">
              ...
              <div class="user-name bg-yellow-100" >{{ user.data.name }}</div>
  ...
  <div v-if="!store.state.user.watingToken">
    <Notification/>
...
<script setup>
import TokenPopupModel from "../components/TokenPopupModel.vue";
...
import { ref } from "vue";
  ...
  //   ];
      ...
      let mssg =ref('');
      mssg.value="Hello "+user.value.data.email;
